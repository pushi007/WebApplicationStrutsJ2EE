                                 ...
                                 <div class="right-top-corner maxheight">
                                    <div class="right-bot-corner maxheight">
                                       <div class="left-bot-corner maxheight">
                                          ...
                                          <div class="inner">
                                          <h3 align="center" style="font-family:Arial,Verdana;font-size:16px;color:#000"></h3>

 <%String message=(String)request.getAttribute("msg") ;%>
 <%List<NonPersonalAccount> npaList=(List<NonPersonalAccount>) request.getAttribute("npList");%>
<table table  align="center" cellpadding=10 cellspacing=10>
<tr>
<%if(message!=null) {%>
<td align="center">
<%=message %></td>
...
<%  for(NonPersonalAccount np:npaList){%>
<tr><td><%=np.getAccNumber()%></td></tr>
<%} %>
</table>
<table align="center">
<tr><td></td><td width="100px"><a href="/NBG/ProductManagementServlet?action=ViewProduct" class="button"><em><b>Ok</b></em></a>
</tr>
</table>
