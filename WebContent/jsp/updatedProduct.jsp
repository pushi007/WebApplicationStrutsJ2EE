                              ...
                              <div class="left-top-corner maxheight">
                                 <div class="right-top-corner maxheight">
                                    <div class="right-bot-corner maxheight">
                                       <div class="left-bot-corner maxheight">
                                         <div class="inner">
                                          <center><h2>Update Product</h2></center><hr/>
<span align=right>Fields marked with <span style="color:red;">*</span> are mandatory&nbsp;&nbsp;&nbsp;</span>
<%Product p=(Product) request.getAttribute("product"); %>
<%List<BusinessType> bList=(List<BusinessType>) request.getAttribute("business"); %>
<%List<BusinessType> businessList=(List<BusinessType>) request.getAttribute("businesType"); %>
<%List<AdditionalProduct> apList=(List<AdditionalProduct>) request.getAttribute("AddProduct"); %>
<%List<AdditionalProduct> aProductList=(List<AdditionalProduct>) request.getAttribute("AddProductList"); %>
...
<td><input id="ProductId" type="text" title="Please Enter Product ID" name="ProductId" value="<%=p.getProductID() %>" readonly="readonly" title="Please Enter Product ID" size='30' width='10' /></td>
</tr>

<tr>
<td ><b>Product Name<sup style="color:red;">*</sup></b></td>
<td><input type='text' name="ProductName" value="<%=p.getProductName() %>" maxlength="40" title="Please Enter Product Name" onblur="validateProductName();"  id="ProductName" size='30' width='10'></td>
...
<td><select id="AccoutnType" name="AccoutnType" title="Please Select Account Type"  onblur="validateAccountType();" ><option value='select'>---------------Select-------------------</option>
...
<td><input type="text" id="ValidFrom" name="ValidFrom" onblur="validateDate();" value="<%=p.getProductValidFrom()%>" title="Please select date" size='30' width='10'  />
...
<td><label id="err_message6" style="color: red;"></label></td></tr>
<tr><td><b>Additional Products</b></td><td></td><td><center><label id="err_message7" style="color:red;"></label></center></td></tr>
<%for(AdditionalProduct ps:apList){ %>
<tr><td></td><td><input type="checkbox" onblur="validationofAdditional();" id="AProduct" name="AProduct" <% for(AdditionalProduct aprod:aProductList){  if(ps.getName().equals(aprod.getName())){out.println("checked");} }%> value="<%=ps.getName()%>"/>
<%=ps.getName()%>
</td>
</tr>
<%} %>
...
<tr><td colspan="1" align="left" ><a href="#" class="button" onClick="return validateformation1();"><em><b>Save</b></em></a></td>
