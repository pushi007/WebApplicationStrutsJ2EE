...
<td colspan="1" width="20%" style="align: center; padding: 10px"><a
			href="/NBG/AccountPartyManagementServlet?action=updatecoredetailsAfterRegistration" class="button"><em><b>Edit</b></em></a></td>
</tr>
</table>
...
<td colspan="1" width="20%" style="align: center; padding: 10px"><a
			href="/NBG/AccountPartyManagementServlet?action=updatPresentAddressAfterRegistration" class="button"><em><b>Edit</b></em></a></td>
</table>
...
<%if(partyDetails.getpPartyPresentAddress().getTownName()=="" || partyDetails.getpPartyPresentAddress().getTownName()==null) {%>
...
<tr>
<td align="left"><b></b></td>
<%if(partyDetails.getpPartyPreviousAddress().getTownName()=="" || partyDetails.getpPartyPreviousAddress().getTownName()==null) {%>
<td align="left"><%=partyDetails.getpPartyPreviousAddress().getPostalCode() %></td>
<%} else {%>
<td align="left"><%=partyDetails.getpPartyPreviousAddress().getTownName()+"-"+partyDetails.getpPartyPreviousAddress().getPostalCode() %></td>
<%}%>
</tr>
...
<td colspan="1" width="20%" style="align: center; padding: 10px"><a
			href="/NBG/AccountPartyManagementServlet?action=updateContactAfterRegistration" class="button"><em><b>Edit</b></em></a></td>
</table>
...
<table width="40%" align="left" cellpadding=10 cellspacing=10>
<tr >
<td width=50% style="align:center;padding:10px"><a href="/NBG/AccountPartyManagementServlet?action=Update_personal_party_details_after_reg" class="button" ><em><b>Update</b></em></a></td>
<td width=50% style="align:center;padding:10px"><a href="/NBG/AccountPartyManagementServlet?action=Display_Business_Cust_Detail" class="button" ><em><b>Cancel</b></em></a></td>
</tr>
</table>
