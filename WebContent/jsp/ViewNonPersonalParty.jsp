...
<title>Business Search Summary</title>
                           ...
                           <div class="border-left maxheight">
                              <div class="left-top-corner maxheight">
                                 <div class="right-top-corner maxheight">
                                  ...
                                  <%List<NonPersonalParty> nonpersonal=(ArrayList<NonPersonalParty>)request.getAttribute("nonpersonallist"); %> 
                                  
                                   <b><small>Click on the link below to obtain Relationship Manager.</small></b>
                                    <hr>
                                   ...
                                   <table align="center" cellspacing="5" border="2">
                                    ...
                                    <tr>
                                     ...
                                     <td align="center"><b>Business Name</b></td>
                                       ...
                                       <td align="center"><b>Assigned Relationship Manager</b></td></tr>
                                       <tr>
                                
                                       <%for(NonPersonalParty npp:nonpersonal) { %>
                                      <td align="center"><%=npp.getNonPersonalId()%></td>
                                        <td align="center"><a href="/NBG/AssignRelationshipManagerServlet?action=show&&npid=<%=npp.getNonPersonalId() %>&&rmid=<%=npp.getRmAssigned()%>"><%=npp.getBusinessName()%></a></td>
                                        <td align="center"><%=npp.getTradingName()%></td>
                                       
                                        <td align="center"><%=npp.getBusinessType()%></td>
                                        
                                        <td align="center"><%=npp.getRmAssigned()%></td></tr>
                                        <%} %>
                                      </table>
						              </form>
