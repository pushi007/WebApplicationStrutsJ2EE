...
function validateAccept(){
	...
	if(flag==0){
		...
		document.termsAndConditions1.submit();
		return true;
	}			
}
...
<form name="termsAndConditions1" id='contacts-form3' method="post" action="/NBG/AccountCreationServlet" onsubmit="return validate();">
<input type="hidden" name="action" value="accepttandc"></input>
...
<td style="padding:10px;"><a href="/NBG/AccountCreationServlet?action=rejecttandc" class="button"><em><b>Reject</b></em></a>
</td></tr>
</table>
</form>
