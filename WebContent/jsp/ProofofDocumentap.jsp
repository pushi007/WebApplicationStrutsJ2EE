...
<table style="height: 100%;" cellpadding="10" cellspacing="10">
	...
	<tr>
		...
		<td><select name="idproof" id="idproof">
			...
			<option value="ITR Return Statement">Bank Account Statement</option>
			<option value="Utility Bill">Driving License</option>
			<option value="emp">Employer Certificate</option>
			<option value="eBill">Electricity Bill</</option>
			<option value="password">Passport</</option>
			<option value="telephone">Telephone Bill</</option>
			<option value="votersid">Voters Identity Card</</option>
			</select></td>
