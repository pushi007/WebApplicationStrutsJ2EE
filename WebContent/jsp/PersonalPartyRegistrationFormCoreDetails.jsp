...
<td width="60%"><label id="err_msg1" style="color: red;" value=" "></label></td>
</tr>

<tr>
<td align="left">First Name<sup><font color="red">*</font></sup></td>
<td align="left"><input type="text" name="firstName" maxlength="20" onblur="return validFName();"/>
</td>
<td><label id="err_msg2" style="color: red;" value=" "></label></td>
</tr>

<tr>
<td align="left">Middle Name</td>
<td align="left"><input type="text" name="middleName" maxlength="20" onblur="return validMName();"/>
</td>
<td><label id="err_msg3" style="color: red;" value=" "></label></td>
</tr>

<tr>
<td align="left">Last Name<sup><font color="red">*</font></sup></td>
<td align="left"><input type="text" name="lastName" maxlength="20" onblur="return validLName();"/>
</td>
<td><label id="err_msg4" style="color: red;" value=" "></label></td>
</tr>

<tr>
<td align="left">Relationship  Type<sup><font color="red">*</font></sup></td>
<td align="left"><select name="relationshipType" id="relationshipType" onblur="return validRelation();">
<option value="select">-- Please Select --</option>
...
<td><label id="err_msg5" style="color: red;" value=" "></label></td>
</tr>

<tr>
<td align="left">Date of Birth(in yyyy/mm/dd)<sup><font color="red">*</font></sup></td>

<td align="left"><input type="text" name="dateOfBirth" id="dateOfBirth" size="12" readonly="readonly"/>
<a href="#"
...
<td><label id="err_msg6" style="color: red;" value=" "></label></td>
</tr>

<tr>
<td align="left">Is Key Party<sup><font color="red">*</font></sup></td>
<td align="left">
<input type="radio" name="keyParty" id="keyYes" value="Yes">Yes</input>
<input type="radio" name="keyParty" id="keyNo" value="No">No</input>
</td>
<td><label id="err_msg7" style="color: red;" value=" "></label></td>
</tr>

<tr>
<td align="left">Is Existing Customer<sup><font color="red">*</font></sup></td>
<td align="left">
<input type="radio" name="existingCustomer" value="Yes" id="Yes" onclick="return isExistingCust();">Yes</input>
<input type="radio" name="existingCustomer" value="No" id="No" onclick="return isNotExistingCust();">No</input>
</td>
<td><label id="err_msg8" style="color: red;" value=" "></label></td>
</tr>

<td align="left">Account Number</td>
<td align="left"><input type="text" name="accountNumber" maxlength="10" id="accNo" disabled=true onblur="return validAccNo();"></td>
<td><label id="err_msg9" style="color: red;" value=" "></label></td>
</tr>

<tr>
<td align="left">Branch</td>
<td align="left"><SELECT id="branchName" name="branchName" disabled=true onblur="return validBranch();">
			<option value="select" selected>-- Please Select --</option>
			<%for(Branch brnch:branch) {%>
			<OPTION VALUE="<%=brnch.getBranchName()%>"><%=brnch.getBranchName()%></OPTION>
			<% }%>
		</SELECT></td>
		<td><label id="err_msg10" style="color: red;" value=" "></label></td>
</tr>

<tr>
<td style="align:center;padding:10px"><a href="#" class="button" onclick="return validateCoreDetailsForm();"><em><b>Continue</b></em></a></td>

<td style="align:center;padding:10px"><a class="button" onclick="document.Account_party_core_details.reset()"><em><b>Reset</b></em></a></td>
</tr>
</table>
