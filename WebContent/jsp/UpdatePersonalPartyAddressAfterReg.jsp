...
<% PersonalPartyAddress PartyPresentAddressObject=new PersonalPartyAddress();
	PartyPresentAddressObject=(PersonalPartyAddress)request.getAttribute("pPartyAddress"); %>

<form name="Account_party_present_address_update" action="/NBG/AccountPartyManagementServlet" method="post">
<input type="hidden" name=action value="Update_Account_party_present_address_after_reg"></input>
...
<td align="left" width="20%"><input type="text" name="presentHouseNo" value="<%=PartyPresentAddressObject.getHouseNo() %>" maxlength="10" onblur="return validHouseNo();"/></td>
<td width="60%"><label id="err_msg1" style="color: red;"></label></td>
</tr>

<tr>
<td align="left">House Name<sup><font color="red">*</font></sup></td>
<td align="left"><input type="text" name="presentHouseName" value="<%=PartyPresentAddressObject.getHouseName() %>" maxlength="30" onblur="return validHouseName();"/></td>
<td><label id="err_msg2" style="color: red;"></label></td>
</tr>

<tr>
<td align="left">Building No<sup><font color="red">*</font></sup></td>
<td align="left"><input type="text" name="presentBuildingNo" value="<%=PartyPresentAddressObject.getBuildingNo() %>" maxlength="10" onblur="return validpresentBuildingNo();"/></td>
<td><label id="err_msg3" style="color: red;"></label></td>
</tr>

<tr>
<td align="left">Street Name<sup><font color="red">*</font></sup></td>
<td align="left"><input type="text" name="presentStreet" value="<%=PartyPresentAddressObject.getStreetName() %>" maxlength="40" onblur="return validpresentStreetName();"/></td>
<td><label id="err_msg4" style="color: red;"></label></td>
</tr>

<tr>
<td align="left">City<sup><font color="red">*</font></sup></td>
<td align="left"><input type="text" name="presentCity" value="<%=PartyPresentAddressObject.getCityName() %>" maxlength="30" onblur="return validpresentCity();"/></td>
<td><label id="err_msg5" style="color: red;"></label></td>
</tr>

<tr>
<td align="left">Town</td>
<%if(PartyPresentAddressObject.getTownName()==null) {%>
<td align="left"><input type="text" name="presentTown" maxlength="30" onblur="return validpresentTown();"/></td>
<%} else {%>
<td align="left"><input type="text" name="presentTown" value="<%=PartyPresentAddressObject.getTownName() %>" maxlength="30" onblur="return validpresentTown();"/></td>
<%} %>
...
<td align="left"><select name="presentCountry" value="<%=PartyPresentAddressObject.getCountryName() %>"/>
...
<td align="left"><input type="text" name="presentPostalCode" value="<%=PartyPresentAddressObject.getPostalCode() %>" maxlength="10" onblur="return validPostalCode();"/></td>
