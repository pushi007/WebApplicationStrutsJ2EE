...
<title>  Relationship Manager Summary</title>
                                    ...
                                    <div class="right-bot-corner maxheight">
                                       <div class="left-bot-corner maxheight">
                                       	<div class="inner">
                                            ...
                                            <%String rmid=(String)request.getAttribute("managerId"); %>
                                           <%RelationshipManager rm=(RelationshipManager)request.getSession().getAttribute("managername"); %>
                                           
                                             <% int npid=(Integer)request.getAttribute("npid");%> 
                                       		
                                       		<%NonPersonalParty npp=(NonPersonalParty) request.getAttribute("npp"); %>
...
<td style="padding:15px;"><label for="businessName"><%=npp.getBusinessName()%></label></td></tr>
<tr>
...
<td style="padding:15px;"><label for="branchName"><%=branchName %></label></td></tr>
<tr>
<td style="padding:15px;"><b>Relationship Manager ID</b></td>
<td style="padding:15px;"><label for="manager"><%=rmid %></label></td>  </tr>
<tr>
<td style="padding:15px;"><b>Relationship Manager Name</b></td>
<td style="padding:15px;"><label for="managername"><%=rm.getTitle()%> <%=rm.getFirstName()%> <%=rm.getLastName() %></label></td>                                 		
</tr>
...
<a href="/NBG/AssignRelationshipManagerServlet?action=termsAndConditions" class="button"><em><b>Ok</b></em></a>
<%} %>
