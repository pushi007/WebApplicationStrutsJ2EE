                                 ...
                                 <div class="right-top-corner maxheight">
                                    <div class="right-bot-corner maxheight">
                                       ...
                                       <center><h2>Welcome Letter</h2></center>
                                             <hr></hr>
                                             <%List<NonPersonalAccount> npaList=(ArrayList<NonPersonalAccount>)request.getAttribute("AccountList");%>
                                             <%List<Product> pList=(ArrayList<Product>)request.getSession().getAttribute("pList"); %>
...
<%for(Product p:pList){ %>
<%if(p.getProductID()==npa.getProductId()){ %>
