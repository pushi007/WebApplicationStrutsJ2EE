...
<title>Assigning Relationship Manager</title>
                              ...
                              <div class="left-top-corner maxheight">
                                 <div class="right-top-corner maxheight">
                                    <div class="right-bot-corner maxheight">
                                       <div class="left-bot-corner maxheight">
                                       <div class="inner">
                                    <center><h2>Assigning Relationship Manager</h2></center>
                                   ...
                                   <th><b>Branch </b></th>
                                   <th><b>Relationship Manager<br>from <br><%if(br.getBranchName()!=null){ %>(<%=br.getBranchName()%>)<%} %>Branch</b></th>
                                   </tr>
                                  ...
                                  <td><label  for="tradingName"><%=nonpersonal.getTradingName()%></label></td>
                                   ...
                                   <table align="center" cellspacing="10">
                                    ...
                                    <td colspan="2" ><center><a href="#"class="button" onclick="document.getElementById('contacts-form1').submit()"><em><b>Assign</b></em></a></center></td>
