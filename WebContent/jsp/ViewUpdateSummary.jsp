...
<%String usernm=(String)session.getAttribute("role"); %>
...
<table>
	...
	<tr>
		<td colspan="2" width=30% style="align: center; padding: 10px"><a
			type="submit"
			href="/NBG/EmployeeManagementServlet?action=update"
			class="button"><em><b>Change</b></em></a></td>
		<td colspan="2" width=30% style="align: center; padding: 10px"><a
			class="button" type="submit"
			href="/NBG/EmployeeManagementServlet?action=confirmUpdate"><em><b>Confirm</b></em></a></td>
		<td colspan="2" width=30% style="padding: 10px"><a href="/NBG/EmployeeManagementServlet?action=viewDetails&&empId=<%=emp.getEmpId() %>"
			class="button" onclick="return Confirm();"><em><b>&nbsp;&nbsp;Cancel&nbsp;&nbsp;</b></em></a></td>
	</tr>
</table>
</div>
</div>
