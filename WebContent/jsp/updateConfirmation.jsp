                              ...
                              <div class="left-top-corner maxheight">
                                 <div class="right-top-corner maxheight">
                                    <div class="right-bot-corner maxheight">
                                       <div class="left-bot-corner maxheight">
                                         <div class="inner">
<h4 align="center" style="font-family:Arial,Verdana;font-size:16px;color:#000">Please select only one Product for updation</h4>  
<form>
<table align="center"><tr></tr>
<tr><td style="align: center;" width="100px"><a type="submit" class="button"  href="/NBG/ProductManagementServlet?action=ViewProduct"><em><b>Ok</b></em></a></td>                                       
</table> 
</form>                                         
