...
<title>Additional Product Report</title>
                              ...
                              <div class="left-top-corner maxheight">
                                 <div class="right-top-corner maxheight">
                                    <div class="right-bot-corner maxheight">
                                       <div class="left-bot-corner maxheight">
                                         <div class="inner">
                                         <center> <h2>Additional Product Report</h2></center><hr/>



<%ArrayList<AdditionalProduct>aplist=(ArrayList<AdditionalProduct>)request.getAttribute("aplist"); %>
<form id="f2" action="#">
<input type="hidden" name="action" value="home"></input>
<table  align="center" cellpadding=1 cellspacing=5 border="1" bordercolor="#D8D8D8">

<tr style="background-color:#D8D8D8; height: 30px;">
<td><b>Additional Product ID</b></td>
<td><b>Additional Product Name</b></td>
