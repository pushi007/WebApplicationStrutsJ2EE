...
<h4><a href="/NBG/ChartController?action=generateBarCAO"><b
	style="font-family: Arial; font-size: 12px;">Bar Chart</b></a></h4>
</div>
</div>
</div>
</div>
...
<IMG SRC="/NBG/ChartController?action=viewPieCAO" WIDTH="600"
	HEIGHT="350" BORDER="0" onerror="this.src='<%=request.getContextPath() %>/images/NoRecordFound.JPG'">
