...
<input type="hidden" name=action value="Update_Account_party_contact_detail"></input>
...
<tr>
<td align="left" width="25%">Email address<sup><font color="red">*</font></sup></td>
...
<tr>
	...
	<td align="left">
	<select id="idProofType" name="idProofType" value="<%=pPartyContactDetails.getIdProofType()%>">
...
<tr>
    ...
    <td align="left">
	<input type="file" name="idProofFile" id="idProofFile" title="Upload a pdf file" value="<%=pPartyContactDetails.getIdProofFile()%>" title="Upload a pdf file" value="idProofFile.pdf">
...
<tr>
    ...
    <td align="left">
	<input type="file" name="addressProofFile" id="addressProofFile" title="Upload a pdf file" value="<%=pPartyContactDetails.getAddressProofFile()%>" title="Upload a pdf file" value="addressProofFile.pdf">
	<br>Upload Proof document in .pdf format 
	</td>
...
<table>
<tr>
<td width="40%"><a href="/NBG/AccountPartyManagementServlet?action=Cancel_party_updation" class="button"><em><b>Cancel</b></em></a>
</td>
</tr>
</table>
</td>
