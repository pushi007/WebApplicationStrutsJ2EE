...
<input type="hidden" name=action value="Update_Account_party_core_detail_update"></input>
...
<td align="left" width="20%"><select name="title" <%if(UpdateType.equals("updateAfterCreation")) { out.println("disabled");} %>>
...
<td align="left"><input type="text" name="firstName" value="<%=personalPartyObject.getFirstName()%>" <%if(UpdateType.equals("updateAfterCreation")) { out.println("readonly");} %> maxlength="20" onblur="return validFName();"/></td>
<td width="60%"><label id="err_msg2" style="color: red;"></label></td>
</tr>

<tr>
<td align="left">Middle Name</td>
<td align="left"><input type="text" name="middleName" value="<%=personalPartyObject.getMiddleName()%>" <%if(UpdateType.equals("updateAfterCreation")) { out.println("readonly");} %> maxlength="20" onblur="return validMName();"/></td>
<td width="60%"><label id="err_msg3" style="color: red;"></label></td>
</tr>

<tr>
<td align="left">Last Name<sup><font color="red">*</font></sup></td>
<td align="left"><input type="text" name="lastName" value="<%=personalPartyObject.getSurName() %>" <%if(UpdateType.equals("updateAfterCreation")) { out.println("readonly");} %> maxlength="20" onblur="return validLName();"/></td>
<td width="60%"><label id="err_msg4" style="color: red;"></label></td>
</tr>
...
<td width="60%"><label id="err_msg5" style="color: red;"></label></td>
</tr>

<tr>
<td align="left">Date of Birth(in yyyy/mm/dd)<sup><font color="red">*</font></sup></td>
<td align="left"><input type="text" name="dateOfBirth" value="<%=personalPartyObject.getDateOfBirth() %>" <%if(UpdateType.equals("updateAfterCreation")) { out.println("readonly");} %>/></td>
...
<td width="60%"><label id="err_msg7" style="color: red;"></label></td>
</tr>
...
<td align="left">
<input type="radio" name="existingCustomer" value="Yes" <%if(personalPartyObject.getIsExistingCustomer().equals("Yes")) { out.println("checked");} %> disabled="true">Yes</input>
<input type="radio" name="existingCustomer" value="No" <%if(personalPartyObject.getIsExistingCustomer().equals("No")) { out.println("checked");} %> disabled="true">No</input>
</td>

<tr>
<td align="left">Account Number</td>
<td align="left"><input type="text" name="accountNumber" value="<%=personalPartyObject.getAccountNumber() %>" disabled="true"/></td>
</tr>

<tr>
<td align="left">Branch</td>
<td align="left"><SELECT id="branchName" name="branchName" disabled="true">
			<%for(Branch brnch:branch) {%>
			<option value="<%=brnch.getBranchName()%>" <%if(personalPartyObject.getBranchId().equals (brnch.getBranchName())){ out.println("selected");} %>><%=brnch.getBranchName()%></option>
			<% }%>
		</SELECT></td>
</tr>
<%} %>
