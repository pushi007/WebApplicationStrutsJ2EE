...
function validateBuildingNoPermanent() {
	var sampleVar = document.updatePerAddress_form.bnoper.value;
...
function validateBuildingNamePermanent() {
	var sampleVar = document.updatePerAddress_form.bnameper.value;
...
function validateStreetNamePermanent() {
	var sampleVar = document.updatePerAddress_form.snameper.value;
	var alphaExp = /^[a-zA-Z][a-zA-Z\s]+$/;
	if (sampleVar == null || sampleVar == "") {
...
function validateCityPermanent() {
	var sampleVar = document.updatePerAddress_form.cityper.value;
	var alphaExp = /^[a-zA-Z][a-zA-Z\s]+$/;
	if (sampleVar == null || sampleVar == "") {
...
function validateTownPermanent() {
	var sampleVar = document.updatePerAddress_form.townper.value;
	var alphaExp = /^[a-zA-Z][a-zA-Z\s]+$/;
...
function validateCountryPermanent() {
	var sampleVar = document.updatePerAddress_form.countryper.value;
	if (sampleVar == "0") {
...
function validatePostalCodePermanent() {
	var sampleVar = document.updatePerAddress_form.pcodeper.value;
...
function validateformper() {
	...
	if (document.updatePerAddress_form.simcheckcorr[0].checked == false
			&& document.updatePerAddress_form.simcheckcorr[1].checked == false) {
		document.getElementById("err_simchkcorr").innerHTML = "Please check address similarity";
		return false;
	}

	document.updatePerAddress_form.submit();
	return true;
}
...
function validBuildingNoCorr() {
	var sampleVar = document.updateCorrAddress_form.bnocor.value;
	var alphaExp = /^[a-zA-Z0-9][a-zA-Z0-9\s()-]+$/;
	var alphaExp1 = /^[a-zA-Z0-9]+$/;
	var alphaExp2 = /^[a-zA-Z]+$/;
	if (sampleVar == null || sampleVar == "") {
...
function validBuildingNameCorr() {
	var sampleVar = document.updateCorrAddress_form.bnamecor.value;
	var alphaExp = /^[a-zA-Z][a-zA-Z\s]+$/;
	if (sampleVar == null || sampleVar == "") {
...
function validStreetNameCorr() {
	var sampleVar = document.updateCorrAddress_form.snamecor.value;
	var alphaExp = /^[a-zA-Z][a-zA-Z\s]+$/;
	if (sampleVar == null || sampleVar == "") {
...
function validCityCorr() {
	var sampleVar = document.updateCorrAddress_form.citycor.value;
	var alphaExp = /^[a-zA-Z][a-zA-Z\s]+$/;
	if (sampleVar == null || sampleVar == "") {
...
function validTownCorr() {
	var sampleVar = document.updateCorrAddress_form.towncor.value;
	var alphaExp = /^[a-zA-Z][a-zA-Z\s]+$/;
...
function validcountryCorr() {
	var sampleVar = document.updateCorrAddress_form.countrycor.value;
	if (sampleVar == "0") {
...
function validPostalCodeCorr() {
	var sampleVar = document.updateCorrAddress_form.pcodecor.value;
...
function validateCorrAddres() {
	...
	document.updateCorrAddress_form.submit();
	return true;
}
