...
function validmobile1()
{
	...
	else if (sampleVar.length<13)
	{
	   document.getElementById("err_msg2").innerHTML="Please enter a 2 digit country code followed by 10 digit mobile number";
	   return false;
	}
	else
	{
...
function validhomeCountryCode()
{
	...
	{
	   document.getElementById("err_msg3").innerHTML="Home contact number should be followed by Country code and Area code";
	   return false;
	}
	else
	{
...
function validofficeCountryCode()
{
	...
	{
	   document.getElementById("err_msg4").innerHTML="Office contact number should be followed by Country code and Area code";
	   return false;
	}
	else
	{
